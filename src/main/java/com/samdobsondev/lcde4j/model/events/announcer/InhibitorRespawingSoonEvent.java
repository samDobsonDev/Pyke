...
public class InhibitorRespawingSoonEvent implements AnnouncerNotificationEvent
{
    ...
    public InhibitorRespawingSoonEvent(AnnouncerNotificationType announcerNotificationType, Double announcerEventTime, Long announcerEventID, AllGameData allGameData, String inhibitorRespawningSoon)
    {

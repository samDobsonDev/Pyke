...
public class InhibitorKillEvent implements AnnouncerNotificationEvent
{
    ...
    public InhibitorKillEvent(AnnouncerNotificationType announcerNotificationType, Double announcerEventTime, Long announcerEventID, AllGameData allGameData, String inhibitorKilled, String killerName, List<String> assisters)
    {

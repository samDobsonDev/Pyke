...
public class HeraldKillEvent implements AnnouncerNotificationEvent
{
    ...
    public HeraldKillEvent(AnnouncerNotificationType announcerNotificationType, Double announcerEventTime, Long announcerEventID, AllGameData allGameData, Boolean stolen, String killerName, List<String> assisters)
    {
